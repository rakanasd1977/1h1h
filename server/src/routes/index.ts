...
router.use('/catalog', adminCatalog);
router.use('/coupons', adminCoupons);
router.use('/reviews', adminReviews);
router.use('/admin/notifications', adminNotify);
router.use('/disputes', disputes);
router.use('/payments', payments);
router.use('/docs', authenticate, requireRole('admin'), docs.registerDocs(express.Router()));
