...
const RESOURCES = [
  ...
  { key: 'districts', label: 'أقضية المحافظات', actions: ['view', 'create', 'edit', 'delete', 'export'] },
  ...
  { key: 'catalog', label: 'كتالوج المتجر', actions: ['view', 'create', 'edit', 'delete', 'export'] },
  { key: 'reviews', label: 'تقييمات الزبائن', actions: ['view', 'delete'] },
  { key: 'notifications', label: 'إرسال الإشعارات', actions: ['view', 'create'] },
  { key: 'disputes', label: 'النزاعات', actions: ['view', 'edit', 'export'] },
  { key: 'security', label: 'الأمان', actions: ['view', 'edit'] },
  { key: 'home_layout', label: 'تخطيط الصفحة الرئيسية', actions: ['view', 'create', 'edit', 'delete'] },
];
