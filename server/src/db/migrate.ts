...
const m_043_promotion_placement = require('./migrations/043_promotion_placement');
const m_044_rbac_catalog_admin = require('./migrations/044_rbac_catalog_admin');
const m_045_rbac_reviews_notifications = require('./migrations/045_rbac_reviews_notifications');
const m_046_rbac_home_layout = require('./migrations/046_rbac_home_layout');
const m_047_mail_sms_settings = require('./migrations/047_mail_sms_settings');
const m_048_provider_verification_enforcement = require('./migrations/048_provider_verification_enforcement');
const m_049_notification_preferences = require('./migrations/049_notification_preferences');
const m_050_disputes_and_invoices = require('./migrations/050_disputes_and_invoices');
const m_051_rbac_disputes = require('./migrations/051_rbac_disputes');
const m_052_payment_gateway_foundation = require('./migrations/052_payment_gateway_foundation');
const m_053_rbac_payment_gateways = require('./migrations/053_rbac_payment_gateways');
const m_054_token_purpose = require('./migrations/054_token_purpose');
...
const MIGRATIONS = [
  ...
  m_043_promotion_placement,
  m_044_rbac_catalog_admin,
  m_045_rbac_reviews_notifications,
  m_046_rbac_home_layout,
  m_047_mail_sms_settings,
  m_048_provider_verification_enforcement,
  m_049_notification_preferences,
  m_050_disputes_and_invoices,
  m_051_rbac_disputes,
  m_052_payment_gateway_foundation,
  m_053_rbac_payment_gateways,
  m_054_token_purpose,
];
