/* Service Worker — سوق الرافدين (تطبيق الزبون)
 * يعمل مع اشتراكات Web Push عبر /push/subscribe.
 * يوفّر: عرض إشعارات فورية + فتح/تركيز عند النقر + استراتيجية تخزين بسيطة. */
const VERSION = 'v1';
const APP_ID = 'rafidain-customer';
...
self.addEventListener('push', (event) => {
  let data = { title: 'سوق الرافدين', body: '', url: '/' };
  try {
...
self.addEventListener('fetch', (event) => {
  ...
  // لا تتدخل مع طلبات API أو الإرسالات المستندة إلى Stream:
