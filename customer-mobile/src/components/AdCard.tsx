    ...
    return (
      ...
      >
        ...
        <div className="ad-card__overlay">
          ...
          <button className="ad-card__cta" type="button" onClick={openProduct}>{t('ad.orderCta')} ←</button>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="ad-card__body">
        <div className="ad-card__badge">{t('ad.badge')}</div>
        <div className="ad-card__title">{ad.item_title}</div>
        <div className="ad-card__sub">{ad.provider_name} · {ad.service_name || ad.service_name_ar}</div>
