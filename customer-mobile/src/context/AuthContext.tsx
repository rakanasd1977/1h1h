...
interface AuthContextValue {
  ...
  resendVerification: (payload: unknown) => Promise<unknown>;
  logout: () => void;
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const resendVerification = useCallback((payload: unknown) => authApi.resendVerification(payload), []);
  ...
  return (
      <AuthContext.Provider value={{ user, setUser, ready, login, register, verifyEmail, resendVerification, logout, refreshUser }}>
      {children}
